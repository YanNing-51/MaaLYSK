...
具体参照MaaFW文档：[2.3 回调协议](https://maafw.com/docs/2.3-CallbackProtocol)和[3.3 Project Interface V2 协议 | 节点通知处理](https://maafw.com/docs/3.3-ProjectInterfaceV2#节点通知处理)
...
```json
{
 ...
 "type": "select",
 "label": "选择关卡难度",
 "description": "9为最高难度，选择前请确保已解锁扫荡",
 "default_case": "关卡9",
 "cases": [
        {
          "name": "关卡9",
